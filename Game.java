...
public class Game extends JPanel {														//Helps in overwriting the paint method
	...
	Racquet racquet1 = new Racquet(this, 0, 350, 30, 5);								//Creates a racquet for Player 1
	Racquet racquet2 = new Racquet(this, 220, 10, 30, 5);								//Creates a racquet for Player 2	
	...
	public void paint(Graphics g) {		
		...
		Graphics2D g2d = (Graphics2D) g;												//provides control over geometry, coordinate transformation, color management and text layout																		//cleans the game
		...
		g2d.setColor(Color.YELLOW);														//Setting the ball's color
		...
		g2d.setColor(Color.ORANGE);														//Adding a watermark (lol)
		g2d.drawString("PING! PONG!", 70, 180);											//Displaying... ("What to draw", x-axis, y-axis)
	}
